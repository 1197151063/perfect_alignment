...
def parse_args():
    parser = argparse.ArgumentParser(description="Go NRGCF")
    ...
    parser.add_argument('--normal_weight',type=float,default=0)
    ...
    parser.add_argument('--comment', type=str, default="IGA")
